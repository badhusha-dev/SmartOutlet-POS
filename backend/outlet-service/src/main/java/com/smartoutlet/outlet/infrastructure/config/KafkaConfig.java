...
public class KafkaConfig {
    ...
    public static final String STAFF_ASSIGNMENT_EVENTS_TOPIC = "staff-assignment-events";
    ...
    @Bean
    public NewTopic staffAssignmentEventsTopic() {
        return TopicBuilder.name(STAFF_ASSIGNMENT_EVENTS_TOPIC)
                .partitions(3)
                .replicas(1)
                .build();
    }
