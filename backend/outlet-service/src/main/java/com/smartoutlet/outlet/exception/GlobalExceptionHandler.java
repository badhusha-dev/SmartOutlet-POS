...
public class GlobalExceptionHandler {
    ...
    public ResponseEntity<ApiResponse<Void>> handleOutletNotFoundException(OutletNotFoundException ex) {
    ...
    public ResponseEntity<ApiResponse<Void>> handleOutletAlreadyExistsException(OutletAlreadyExistsException ex) {
